...
export const qgdCambridgeSprings: Lesson = {
  ...
  mainLine: {
    ...
    line: [
      ...
      { san: 'Bd3', comment: 'The most challenging — White builds the Bd3+Qc2 battery against h7.' },
      { san: 'dxc4', comment: 'Now Black cashes in: the bishop on d3 is on a diagonal that helps Black gain a tempo with ...dxc4.', keyIdea: 'Take and hit the bishop.' },
      { san: 'Bxc4', comment: '' },
      { san: 'Nb6', comment: 'A central Cambridge resource — the knight steps out and asks the c4-bishop, gaining a tempo.' },
      { san: 'Bd3', comment: '' },
      { san: 'Nbd5', comment: 'Black drops a knight onto the d5-blockade square — the typical Cambridge equalising motif. Position is balanced; White has marginal pressure, Black has solved the development problem.' },
    ],
  },
  variations: [
    {
