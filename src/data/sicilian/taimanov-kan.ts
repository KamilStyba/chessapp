...
export const sicTaimanovKan: Lesson = {
  ...
  mainLine: {
    ...
    line: [
      ...
      { san: 'Nb3', comment: 'Sidesteps to free the c-file and prepare g4 push.' },
      { san: 'b5', comment: 'Counter-storm! Black gains queenside space.' },
      { san: 'Kb1', comment: 'Prophylactic — getting off the c-file.' },
      { san: 'Bb7', comment: 'Completing development; the long diagonal hits e4.' },
      { san: 'g4', comment: 'The kingside storm begins; both sides race to mate first.' },
      { san: 'Nc4', comment: 'Bouncing into the outpost — typical Taimanov tactical resource.' },
      { san: 'Bxc4', comment: 'White is forced to trade — accepting structural weakening.' },
      { san: 'Qxc4', comment: 'Black\'s queen lands on a useful square; the middlegame is sharp and unclear.' },
    ],
  },
  variations: [
    {
      ...
      line: [
        ...
        { san: 'g6', comment: 'Defending g7 prophylactically.' },
        { san: 'Qe2', comment: 'The queen retreats; mission accomplished — Black\'s kingside is weakened.' },
        { san: 'Nf6', comment: '' },
        { san: 'O-O', comment: '' },
        { san: 'd6', comment: 'Black builds a solid Hedgehog structure.' },
        { san: 'Nc3', comment: '' },
        { san: 'Nbd7', comment: 'Standard Hedgehog deployment; both sides have clear plans.' },
      ],
    },
    {
      id: 'maroczy-taimanov',
